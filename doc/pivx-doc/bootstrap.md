...
Wait until the import finishes. The client will download the last days not covered by the import. Congratulations you have succfully imported the blockchain!

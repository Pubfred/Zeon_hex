...
In order to support loading of multiple wallets in zeon-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zeon.cpp.
...
Changes to zeon.cpp
----------------------
zeon.cpp is the entry point into zeon-qt, and as such, will require some minor modifications to provide hooks for

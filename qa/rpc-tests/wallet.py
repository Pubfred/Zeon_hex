...
#   c) node1 mines 32 blocks, so now node 0 has 60001zeon, node 1 has 4250zeon, node2 has none.
#   d) node0 sends 601 zeon to node2, in two transactions (301 zeon, then 300 zeon).

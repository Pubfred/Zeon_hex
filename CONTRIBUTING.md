Contributing to ZEON Core
============================

The ZEON Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ZEON Core project, and is not to be
confused with overall ZEON Network Protocol consensus changes.

Whether a pull request is merged into ZEON Core rests with the project merge
...
Patches that change ZEON consensus rules are considerably more involved than
...
Where a patch set proposes to change the ZEON consensus, it must have been
...
The project leader is the release manager for each ZEON Core release.

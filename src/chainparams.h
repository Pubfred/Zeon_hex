 ...
 * ZEON system. There are three: the main network on which people trade goods
...
public:
    ...
    const std::vector<unsigned char>& xZEONDevKey() const { return vZEONDevKey; }
    const std::vector<unsigned char>& xZEONFundKey() const { return vZEONFundKey; }
...
protected:
    ...
    std::vector<unsigned char> vZEONDevKey;
    std::vector<unsigned char> vZEONFundKey;
    int nDevFee;
    int nFundFee;
    int nDefaultPort;

...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ZEON address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ZEON: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ZEON Core"), this);
    aboutAction->setStatusTip(tr("Show information about ZEON Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ZEON"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ZEON addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ZEON addresses"));
    ...
    openAction->setStatusTip(tr("Open a ZEON: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the ZEON Core help message to get a list with possible ZEON command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ZEON Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ZEON network", "", count));
}
...
{
    QString strTitle = tr("ZEON Core"); // default title

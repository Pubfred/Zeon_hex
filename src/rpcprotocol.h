...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! ZEON is not connected
    RPC_CLIENT_IN_INITIAL_DOWNLOAD = -10, //! Still downloading initial blocks
    RPC_CLIENT_NODE_ALREADY_ADDED = -23,  //! Node is already added
    RPC_CLIENT_NODE_NOT_ADDED = -24,      //! Node has not been added before
    RPC_CLIENT_NODE_NOT_CONNECTED = -29, //! Node to disconnect not found in connected 
...
public:
    ...
    bool connect(const std::string& server, const std::string& port)
    {
        ...
        try {
            ...
            // If we at first don't szeoneed, try blanket lookup (IPv4+IPv6 independent of configured interfaces)

...
private:
    ...
    static szeoneed tryConvert(const T2&);
...
#pragma warning(disable : 4267)
    ...
    static const bool value =
        sizeof(tryConvert(makeT1())) == sizeof(szeoneed);
#ifdef _MSC_VER
#pragma warning(pop)
#endif
};
    ...
    int variablePrecision)
{
    ...
    case 'o':       /* FALLTHRU */
        ...
        break;
    case 'X':        /* FALLTHRU */  
        out.setf(std::ios::uppercase);  /* FALLTHRU */
    case 'x':         /* FALLTHRU */
    case 'p':          /* FALLTHRU */ 
    ...
    case 'E':          /* FALLTHRU */
        out.setf(std::ios::uppercase);   /* FALLTHRU */
    case 'e':           /* FALLTHRU */  
        out.setf(std::ios::scientific, std::ios::floatfield);   /* FALLTHRU */
        out.setf(std::ios::dec, std::ios::basefield);   /* FALLTHRU */
        break;
    case 'F':           /* FALLTHRU */
        out.setf(std::ios::uppercase);   /* FALLTHRU */
    case 'f':           /* FALLTHRU */  
        out.setf(std::ios::fixed, std::ios::floatfield);   /* FALLTHRU */
        break;
    case 'G':           /* FALLTHRU */
        out.setf(std::ios::uppercase);    /* FALLTHRU */
    case 'g':           
        ...
        out.flags(out.flags() & ~std::ios::floatfield);  /* FALLTHRU */
        break;
    case 'a':              /* FALLTHRU */
    case 'A':              /* FALLTHRU */
        TINYFORMAT_ERROR("tinyformat: the %a and %A conversion specs "
                         "are not supported");   /* FALLTHRU */
        break;
    case 'c':            /* FALLTHRU */

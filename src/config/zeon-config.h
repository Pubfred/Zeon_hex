/* src/config/zeon-config.h.  Generated from zeon-config.h.in by configure.  */
/* src/config/zeon-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ZEON_CONFIG_H

#define ZEON_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.zeonnetwork.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ZEON Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ZEON Core 3.0.2"

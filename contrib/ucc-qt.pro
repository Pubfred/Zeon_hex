...
RESOURCES += src/qt/zeon.qrc src/qt/zeon_locale.qrc

TRANSLATIONS += src/qt/locale/zeon_bg.ts \
                src/qt/locale/zeon_de.ts \
                src/qt/locale/zeon_en.ts \
                src/qt/locale/zeon_es.ts \
                src/qt/locale/zeon_fi.ts \
                src/qt/locale/zeon_fr.ts \
                src/qt/locale/zeon_it.ts \
                src/qt/locale/zeon_ja.ts \
                src/qt/locale/zeon_pl.ts \
                src/qt/locale/zeon_pt.ts \
                src/qt/locale/zeon_ru.ts \
                src/qt/locale/zeon_sk.ts \
                src/qt/locale/zeon_sv.ts \
                src/qt/locale/zeon_vi.ts \
                src/qt/locale/zeon_zh_CN.ts \
                src/qt/locale/zeon_zh_TW.ts
